...
//TODO: Create a simple class that represents a person. The person should have at least two properties, an age and a name. Also one function "haveBirthday" function that increases the persons age. Class start with a upper case.
class Person {
...
let me = Person(name: "Abbie", age: 21)
let someone = Person(name: "Connor", age: 23)
//TODO: Print out the persons name.

//TODO: Show that the birthday function works.
